...
// for comparators we need to declare it as static if we are writing it inside any class, if we are writiing it outside of any class then we can initialize it normally
