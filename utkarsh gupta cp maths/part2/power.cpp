...
// the process of doing a^b is very easy in O(b) time .. we just have to iterate for b times by multipling with a.. but that is in O(b) time so we have to do that in less time ..
// so ..
